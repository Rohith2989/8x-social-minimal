...
export function Header() {
  ...
  useEffect(() => {
    const targets = ['work', 'day-to-day', 'reach', 'comparison', 'partner-feedback', 'services', 'dashboard', 'reach-atlas', 'family'].map(id => document.getElementById(id)).filter((el): el is HTMLElement => !!el);
